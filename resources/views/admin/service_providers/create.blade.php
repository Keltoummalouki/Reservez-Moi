...
<head>
    ...
    <meta name="description" content="Ajouter un nouveau prestataire de services">
            ...
            <div class="px-4 py-6 sm:px-0">
                <div class="bg-white rounded-lg shadow p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-bold text-gray-800">Ajouter un Prestataire</h1>
                    ...
                    <form action="{{ route('admin.service_providers.store') }}" method="POST" class="space-y-6">
                        @csrf
