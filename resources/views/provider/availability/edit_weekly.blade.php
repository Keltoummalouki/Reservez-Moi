...
<head>
    ...
    <meta name="description" content="Modifier une disponibilité hebdomadaire pour votre service sur Reservez-Moi.">
    <meta name="keywords" content="disponibilités, service provider, réservations">
    <title>Modifier une disponibilité hebdomadaire - Reservez-Moi</title>
        ...
        <div class="bg-white shadow-sm">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16 items-center">
                    <h1 class="text-xl font-bold text-gray-800">Modifier une disponibilité hebdomadaire</h1>
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <div class="md:flex md:items-center md:justify-between mb-6">
                <div class="flex-1 min-w-0">
                    <h2 class="text-lg font-bold text-gray-900 sm:text-xl">
                        Modifier une disponibilité hebdomadaire
                    </h2>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form action="{{ route('provider.availability.update-weekly', [$service->id, $availability->id]) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    <input id="start_time" name="start_time" type="time" class="block w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm" value="{{ \Carbon\Carbon::parse($availability->start_time)->format('H:i') }}" required>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="mt-1 relative">
                                    <input id="end_time" name="end_time" type="time" class="block w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm" value="{{ \Carbon\Carbon::parse($availability->end_time)->format('H:i') }}" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 relative">
                                <input id="max_reservations" name="max_reservations" type="number" min="1" class="block w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm" value="{{ $availability->max_reservations }}" required>
                            </div>
