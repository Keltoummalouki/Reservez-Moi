...
<head>
    ...
    <meta name="description" content="Créer un nouveau service - Reservez-Moi">
    <meta name="keywords" content="service, création, prestataire">
        ...
        <div class="bg-white shadow-sm">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16 items-center">
                    <h1 class="text-xl font-bold text-gray-800">Créer un service</h1>
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="p-6 border-b border-gray-200">
                    <h2 class="text-lg font-bold text-gray-900">Informations du service</h2>
                    <p class="text-sm text-gray-600 mt-1">Créez un nouveau service à proposer à vos clients</p>
                </div>
                ...
                <form action="{{ route('provider.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500" placeholder="Ex: Consultation juridique">
                    </div>
                    
                    <!-- Service Description -->
                    <div class="mb-6">
                        <label for="description" class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                        <textarea name="description" id="description" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500" placeholder="Décrivez les détails de votre service...">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="price" id="price" step="0.01" min="0" value="{{ old('price') }}" required class="w-full pl-8 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500" placeholder="0.00">
                            </div>
                        </div>
                    ...
                    <div class="mb-6">
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" name="is_available" id="is_available" value="1" {{ old('is_available', 1) ? 'checked' : '' }} class="h-4 w-4 text-primary-600 focus:ring-primary-500 border-gray-300 rounded">
                    ...
                    <!-- Service Photos -->
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Photos du service</label>
